...
namespace IT.TnDigit.ORM.Configurator.Classi
{
    abstract class Procedures
    {
        static public Boolean WriteObject(object itm)
        {
            ...
            content = p.WriteProcedureObject(
                itm,
                content,
        ...
        private static string GetModel()
        {
            StreamReader sr = new StreamReader(
                Path.Combine(System.Windows.Forms.Application.StartupPath, "Schemi\\Schema_Procedure.txt"));
            string model = sr.ReadToEnd();
            sr.Close();
            //string model = global::IT.InfoTn.Framework.DataTypesCreator.Properties.Resources.Schema_Procedure;
        ...
        {
            string path = Path.Combine(Params.Instance.Domain.FilePath, "Procedure");
